...
Test(SUITE, TEST_NAME, .init = init, .fini = killall, .timeout = 100)
{
...
#define TEST_NAME busy_signal_test
static TEST_STEP SCRIPT(TEST_NAME)[] = {
    // ID,  COMMAND,          ID_TO_DIAL,    RESPONSE,       TIMEOUT
    {   0,  TU_CONNECT_CMD,    -1,           TU_ON_HOOK,     HND_MSEC },
    {   1,  TU_CONNECT_CMD,    -1,           TU_ON_HOOK,     HND_MSEC },
    ...
    {   0,  TU_DIAL_CMD,        1,           TU_BUSY_SIGNAL, TEN_MSEC },
    {   0,  TU_PICKUP_CMD,     -1,           TU_BUSY_SIGNAL, FTY_MSEC },
    {   1,  TU_DISCONNECT_CMD, -1,           -1,             TEN_MSEC },
    {   0,  TU_HANGUP_CMD,     -1,           TU_ON_HOOK,     FTY_MSEC },
    {   0,  TU_DISCONNECT_CMD, -1,           -1,             TEN_MSEC },
    {   -1, -1,                -1,           -1,             ZERO_SEC }
...
#define TEST_NAME busy_signal_test2
static TEST_STEP SCRIPT(TEST_NAME)[] = {
    // ID,  COMMAND,          ID_TO_DIAL,    RESPONSE,       TIMEOUT
    {   0,  TU_CONNECT_CMD,    -1,           TU_ON_HOOK,     HND_MSEC },
    {   1,  TU_CONNECT_CMD,    -1,           TU_ON_HOOK,     HND_MSEC },
    ...
    {   1,  TU_PICKUP_CMD,     -1,           TU_CONNECTED,   FTY_MSEC },
    {   2,  TU_DIAL_CMD,        1,           TU_BUSY_SIGNAL, TEN_MSEC },
    {   0,  TU_HANGUP_CMD,     -1,           TU_ON_HOOK,     FTY_MSEC },
    {   0,  TU_DISCONNECT_CMD, -1,           -1,             TEN_MSEC },
...
#define TEST_NAME busy_signal_test3
static TEST_STEP SCRIPT(TEST_NAME)[] = {
    // ID,  COMMAND,          ID_TO_DIAL,    RESPONSE,       TIMEOUT
    {   0,  TU_CONNECT_CMD,    -1,           TU_ON_HOOK,     HND_MSEC },
    {   0,  TU_PICKUP_CMD,     -1,           TU_DIAL_TONE,   TEN_MSEC },
...
#define TEST_NAME server_disconnect_test
static TEST_STEP SCRIPT(TEST_NAME)[] = {
    // ID,  COMMAND,          ID_TO_DIAL,    RESPONSE,       TIMEOUT
    {   0,  TU_CONNECT_CMD,    -1,           TU_ON_HOOK,     HND_MSEC },
    {   1,  TU_CONNECT_CMD,    -1,           TU_ON_HOOK,     HND_MSEC },
...
#define TEST_NAME dial_error
static TEST_STEP SCRIPT(TEST_NAME)[] = {
    // ID,  COMMAND,          ID_TO_DIAL,    RESPONSE,       TIMEOUT
    {   0,  TU_CONNECT_CMD,    -1,           TU_ON_HOOK,     HND_MSEC },
    {   1,  TU_CONNECT_CMD,    -1,           TU_ON_HOOK,     HND_MSEC },
    {   0,  TU_PICKUP_CMD,     -1,           TU_DIAL_TONE,   TEN_MSEC },
    {   0,  TU_DIAL_CMD,        2,           TU_ERROR,       TEN_MSEC },
    {   0,  TU_DIAL_CMD,        1,           TU_ERROR,       TEN_MSEC },
    {   0,  TU_PICKUP_CMD,     -1,           TU_ERROR,       TEN_MSEC },
